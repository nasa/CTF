...
class CtfFileEditor extends React.Component<EditorProps, EditorProps, any> {
    ...
    getList = (droppableId: string): Array<any> => {
        if (droppableId.startsWith(COMMAND_LIB_DROPPABLE_PREFIX)) {
            ...
            return this.state.ctfFile.tests.find(t => t.case_number === caseNum)
                .instructions;
          ...
          <PageHeader
            title={
              <div>
                ...
                <Text
                  editable={{
                    onChange: str => this.onMetaDataChanged({ test_name: str })
                  }}
                >
                  {data.test_name}
                </Text>
            ...
            subTitle={
              <Text
                editable={{
                  onChange: str => this.onMetaDataChanged({ test_number: str })
                }}
              >
                {data.test_number}
              </Text>
