...
#
# File: UseProjectDir.ts
#
# Purpose: This file defines UseProjectDir class.
#
...
export class UseProjectDir {
    static async use(dir: string): Promise<FileTree> {
        return FindJsonFiles.find(dir).then((fileTree) => {
            return fileTree;
        });
    }
}