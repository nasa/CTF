...
#
# File: local_cfs_interface.py
#
# Purpose: This file defines lower-level interface to communicate with cFS locally (linux).
#
# Note: This file was created at the NASA Johnson Space Center.
# =========================================================================================

"""
@namespace core_plugins.cfs.pycfs.local_cfs_interface
...
class LocalCfsInterface(CfsInterface):
    ...
    def __init__(self, config, telemetry, command, mid_map, ccsds, macro_map=None):
        ...
        """
        super().__init__(config, telemetry, command, mid_map, ccsds, macro_map)
