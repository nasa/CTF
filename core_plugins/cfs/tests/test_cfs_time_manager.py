...
#
# File: test_cfs_time_manager.py
#
# Purpose: This file contains test cases for unit testing of CfsTimeManager functions.
#
...
@patch("core_plugins.cfs.cfs_time_manager.CfsTimeManager.pre_command")
@patch("core_plugins.cfs.cfs_time_manager.CfsTimeManager.post_command")
@patch("core_plugins.cfs.cfs_time_manager.CfsTimeManager.handle_test_exception_during_wait")
...
def test_wait_exception(mock_handle, mock_pre, time_mgr):
    wait_time = 0.25
    with patch('core_plugins.cfs.cfs_time_manager.CfsTimeManager.post_command') as mock_post_command:
