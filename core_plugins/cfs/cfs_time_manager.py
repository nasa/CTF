...
#
# File: cfs_time_manager.py
#
# Purpose: This file defines CFS Time Manager (CfsTimeManager) for CTF.
#
...
from core_plugins.cfs.pycfs.cfs_interface import CtfConditionError
