...
# File: cfs_plugin.py
#
# Purpose: This file defines CFS Plugin Implementation for CTF.
#
...
from core_plugins.cfs.pycfs.cfs_controllers import CfsController, RemoteCfsController
...
class CfsPlugin(Plugin):
    ...
    def send_raw_cfs_command(self, mid: str, cc: int, hex_buffer: str, target: str = None, header: dict = None) -> bool:
        ...
        # pylint: disable=invalid-name
        target = resolve_variable(target)
        hex_buffer = resolve_variable(hex_buffer)
