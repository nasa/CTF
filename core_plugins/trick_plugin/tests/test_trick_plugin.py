...
#
# File: test_trick_plugin.py
#
# Purpose: This file contains test cases for unit testing of TrickPlugin functions.
#
...
from core_plugins.trick_plugin.trick.variable_server import VariableServerError
from core_plugins.trick_plugin.trick_plugin import TrickPlugin, convert_type, TrickController
...
def _trick_controller_instance():
    with patch("core_plugins.trick_plugin.trick_plugin.VariableServer"):
...
def test_trick_get_controller(trick_plugin):
    with patch("core_plugins.trick_plugin.trick_plugin.VariableServer") as mock_vs:
