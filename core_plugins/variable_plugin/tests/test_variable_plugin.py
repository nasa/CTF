...
#
# File: test_variable_plugin.py
#
# Purpose: This file contains test cases for unit testing of VariablePlugin functions.
#
...
from core_plugins.variable_plugin.variable_plugin import VariablePlugin
...
def test_variable_set_user_defined_variable_str_convert(variable_plugin):
    assert variable_plugin.set_user_defined_variable('variable_1', '=', 10)
    assert variable_plugin.check_user_defined_variable('variable_1', '==', '10')
    assert variable_plugin.check_user_defined_variable('variable_1', '==', '10', 'int')
    assert variable_plugin.check_user_defined_variable('variable_1', '==', '10', 'int')
    Global.variable_store.clear()


def test_variable_set_user_defined_variable_type_convert(variable_plugin, utils):
    assert variable_plugin.set_user_defined_variable('variable_1', '=', 10)
    assert variable_plugin.check_user_defined_variable('variable_1', '==', '10', 'int')
    utils.clear_log()
    assert not variable_plugin.check_user_defined_variable('variable_1', '==', '10', 'invalid_type')
    utils.has_log("Cast type invalid_type not supported")
    utils.clear_log()
    assert not variable_plugin.check_user_defined_variable('variable_1', '==', 'abc', 'int')
    utils.has_log("Could not type cast variable:'10' or value:'abc'")
    Global.variable_store.clear()
