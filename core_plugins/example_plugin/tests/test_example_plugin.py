...
#
# File: test_example_plugin.py
#
# Purpose: This file contains test cases for unit testing of ExamplePlugin functions.
#
...
from core_plugins.example_plugin.example_plugin import ExamplePlugin
