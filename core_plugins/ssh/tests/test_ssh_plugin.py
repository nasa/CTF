...
#
# File: test_ssh_plugin.py
#
# Purpose: This file contains test cases for unit testing of SshPlugin functions.
#
...
def test_ssh_plugin_init_connection_exception(ssh_plugin_instance):
    ...
    """
    with patch('core_plugins.ssh.ssh_plugin.SshController.init_connection') as mock_init_connection:
...
def test_ssh_plugin_run_command_local(ssh_plugin_instance):
    ...
    with patch('core_plugins.ssh.ssh_plugin.SshController.run_command_local', return_value=True):
...
def test_ssh_plugin_check_output(ssh_plugin_instance):
    ...
    with patch('core_plugins.ssh.ssh_plugin.SshController.check_output', return_value=True):
...
def test_ssh_plugin_put_file(ssh_plugin_instance):
    ...
    with patch('core_plugins.ssh.ssh_plugin.SshController.put_file', return_value=True):
...
def test_ssh_plugin_get_file(ssh_plugin_instance):
    ...
    with patch('core_plugins.ssh.ssh_plugin.SshController.get_file', return_value=True):
...
def test_ssh_plugin_upload_ftp(ssh_plugin_instance):
    ...
    with patch('core_plugins.ssh.ssh_plugin.SshController.upload_ftp', return_value=True):
...
def test_ssh_plugin_download_ftp(ssh_plugin_instance):
    ...
    with patch('core_plugins.ssh.ssh_plugin.SshController.download_ftp', return_value=True):
...
def test_ssh_controller_get_file(ssh_controller_instance):
    ...
    with patch('core_plugins.ssh.ssh_plugin.transfers.rsync', return_value=True), \
         patch('fabric.connection.Connection.is_connected', return_value=True):
...
def test_ssh_controller_get_file_exception(ssh_controller_instance, utils):
    ...
    with patch('core_plugins.ssh.ssh_plugin.transfers.rsync') as mock_rsync, \
            patch('fabric.connection.Connection.is_connected', return_value=True):
