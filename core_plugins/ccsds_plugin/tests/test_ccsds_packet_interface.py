...
#
# File: test_ccsds_packet_interface.py
#
# Purpose: This file contains test cases for unit testing of ccsds_packet_interface functions.
#
...
from core_plugins.ccsds_plugin.ccsds_packet_interface import CcsdsVer, CcsdsPacketType, CcsdsPacketInterface, \
...
def test_ccsdspacketinterface_get_sequence_count(packet_interface):
    ...
    """
    with pytest.raises(NotImplementedError):
        packet_interface.get_sequence_count()
...
def test_ccsds_packet_interface_import_ccsds_header_types_module_attributes():
    ...
    in the config value 'CCSDS_header_path' and if found, returns them in a tuple.
    """
    headers_path = "./core_plugins/ccsds_plugin/cfe/ccsds_v2/ccsds_v2.py"
