...
#
# File: test_ccsds_plugin.py
#
# Purpose: This file contains test cases for unit testing of ccsds_plugin functions.
#
...
def test_ccsds_plugin_validate_cfs_ccsds_data_fail(ccsds_plugin_instance, utils, cfs_plugin_instance):
    ...
    utils.clear_log()
    # plugin manager is not initialized yet
    with patch("core_plugins.ccsds_plugin.ccsds_plugin.CCSDSPlugin.get_cfs_plugin", return_value=None):
...
def test_ccsds_plugin_validate_cfs_ccsds_data(ccsds_plugin_instance, cfs_plugin_instance):
    ...
    with patch('core_plugins.cfs.cfs_plugin.CfsPlugin.send_cfs_command', return_value=True), \
