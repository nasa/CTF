...
# File: ccsds_v2.py
#
# Purpose: This file defines the CCSDS v2 message types used by CFE.
#
...
from core_plugins.ccsds_plugin.cfe.ccsds_secondary_header import CcsdsSecondaryCmdHeader, CcsdsSecondaryTlmHeader
...
class CcsdsV2TlmPacket(CcsdsV2Packet):
    ...
    def get_msg_size(self):
        ...
        """
        # Explained in document CCSDS 133.0.2: Essentially packet length in the header doesn't count
        # the primary header and then subtracts one from what's left, which gives the offset 7.
        return self.pheader.get_packet_length() + 7
